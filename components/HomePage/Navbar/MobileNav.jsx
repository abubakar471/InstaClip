...
export function MobileNav() {
    ...
    return (
        <Sheet open={isSheetOpen} onClose={() => setSheetOpen(false)} onOpenChange={() => setSheetOpen(!isSheetOpen)}>
            ...
            <button className='bg-gradient-to-b from-[#445c73] via-[#1E1F40] to-[#445c73] text-white px-5 py-2 rounded-full flex md:hidden items-center gap-x-2' onClick={() => setSheetOpen(true)}>     <Menu /></button>
