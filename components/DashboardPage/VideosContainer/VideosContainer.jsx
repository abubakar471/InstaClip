  ...
  const fetchVideos = async (currentPage) => {
    try {
      ...
      const response = await axios.get(
        ...
        }/assets/get-videos?user_id=${userId}&&limit=${limit}&&asset_status=${asset_status}&&page=${
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="bg-[#000D18] flex flex-col gap-y-2 border-none">
                        ...
                        <button
                          ...
                          className="mt-2 bg-[#9e3333] !text-white py-2 md:py-2 px-3 rounded hover:bg-[#802e2e] flex items-center justify-start gap-x-2 border-none text-sm"
                        >
                          <MdDelete />
                          Delete Clip
                        </button>
